...
def main(args):
    X_train, X_test, y_train, y_test, num_names, cat_names, final_names = get_cis_data(seed = args.seed)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--eps1', type=float, help='bound of numerical features', default= 0.2)
